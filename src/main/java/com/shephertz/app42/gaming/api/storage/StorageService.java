...
public class StorageService extends App42Service {
	...
	public App42Response findAllDocuments(String dbName, String collectionName, int max, int offset)
		...
		try {
			...
			Hashtable<String, String> signParams = this.populateSignParams(WarpClient.getInstance().getAPIKey());
			...
			String signature = Util.sign(WarpClient.getInstance().getPrivateKey(), signParams);
