...
public class GwtWarpClient extends JavaScriptObject implements WarpClient {
	...
	public final native void addConnectionRequestListener(ConnectionRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onConnectDone, function (res, reasonCode) {
            listener.@de.SimonIT.gdxAppWarp.listener.ConnectionRequestListener::onConnectDone(Lde/SimonIT/gdxAppWarp/events/ConnectEvent;)(@de.SimonIT.gdxAppWarp.events.ConnectEvent::new(BI)(res, reasonCode));
        });
        this.setResponseListener($wnd.AppWarp.Events.onDisconnectDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.ConnectionRequestListener::onDisconnectDone(Lde/SimonIT/gdxAppWarp/events/ConnectEvent;)(@de.SimonIT.gdxAppWarp.events.ConnectEvent::new(B)(res));
        });
        this.setResponseListener("onInitUDPDone", function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.ConnectionRequestListener::onInitUDPDone(B)(res);
        });
    }-*/;
	...
	public final native void addZoneRequestListener(ZoneRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onDeleteRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onDeleteRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetAllRoomsDone, function (rooms) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetAllRoomsDone(Lde/SimonIT/gdxAppWarp/events/AllRoomsEvent;)(@de.SimonIT.gdxAppWarp.events.AllRoomsEvent::new(B[Ljava/lang/String;)(rooms.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaByteArray(*)(rooms.getRoomIds())));
        });
        this.setResponseListener($wnd.AppWarp.Events.onCreateRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onCreateRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetOnlineUsersDone, function (users) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetOnlineUsersDone(Lde/SimonIT/gdxAppWarp/events/AllUsersEvent;)(@de.SimonIT.gdxAppWarp.events.AllUsersEvent::new(B[Ljava/lang/String;)(users.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaByteArray(*)(users.getUsernames())));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetLiveUserInfoDone, function (user) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetLiveUserInfoDone(Lde/SimonIT/gdxAppWarp/events/LiveUserInfoEvent;)(@de.SimonIT.gdxAppWarp.events.LiveUserInfoEvent::new(BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)(user.getResult(), user.getLocationId(), user.getName(), user.getCustomData(), user.isLobby(), user.isPaused()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onSetCustomUserDataDone, function (user) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onSetCustomUserDataDone(Lde/SimonIT/gdxAppWarp/events/LiveUserInfoEvent;)(@de.SimonIT.gdxAppWarp.events.LiveUserInfoEvent::new(BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)(user.getResult(), user.getLocationId(), user.getName(), user.getCustomData(), user.isLobby(), user.isPaused()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetMatchedRoomsDone, function (event) {
            var roomDatas = [];
            var rooms = event.getRooms();
            for (var i = 0; i < rooms.length; i++) {
                roomDatas[i] = @de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(rooms[i].getRoomId(), rooms[i].getOwner(), rooms[i].getName(), rooms[i].getMaxUsers());
            }
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetMatchedRoomsDone(Lde/SimonIT/gdxAppWarp/events/MatchedRoomsEvent;)(@de.SimonIT.gdxAppWarp.events.MatchedRoomsEvent::new(B[Lde/SimonIT/gdxAppWarp/events/RoomData;)(event.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaArray(*)(roomDatas)));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetAllRoomsCountDone, function (result, count) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetAllRoomsCountDone(Lde/SimonIT/gdxAppWarp/events/AllRoomsEvent;)(@de.SimonIT.gdxAppWarp.events.AllRoomsEvent::new(BI)(result, count));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetOnlineUsersCountDone, function (result, count) {
            listener.@de.SimonIT.gdxAppWarp.listener.ZoneRequestListener::onGetOnlineUsersCountDone(Lde/SimonIT/gdxAppWarp/events/AllUsersEvent;)(@de.SimonIT.gdxAppWarp.events.AllUsersEvent::new(IB)(count, result));
        });
	...
	public final native void addLobbyRequestListener(LobbyRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onJoinLobbyDone, function (lobby) {
            listener.@de.SimonIT.gdxAppWarp.listener.LobbyRequestListener::onJoinLobbyDone(Lde/SimonIT/gdxAppWarp/events/LobbyEvent;)(@de.SimonIT.gdxAppWarp.events.LobbyEvent::new(Lde/SimonIT/gdxAppWarp/events/LobbyData;B)(@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getLobbyId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary()), lobby.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onLeaveLobbyDone, function (lobby) {
            listener.@de.SimonIT.gdxAppWarp.listener.LobbyRequestListener::onLeaveLobbyDone(Lde/SimonIT/gdxAppWarp/events/LobbyEvent;)(@de.SimonIT.gdxAppWarp.events.LobbyEvent::new(Lde/SimonIT/gdxAppWarp/events/LobbyData;B)(@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getLobbyId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary()), lobby.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onSubscribeLobbyDone, function (lobby) {
            listener.@de.SimonIT.gdxAppWarp.listener.LobbyRequestListener::onSubscribeLobbyDone(Lde/SimonIT/gdxAppWarp/events/LobbyEvent;)(@de.SimonIT.gdxAppWarp.events.LobbyEvent::new(Lde/SimonIT/gdxAppWarp/events/LobbyData;B)(@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getLobbyId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary()), lobby.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onUnsubscribeLobbyDone, function (lobby) {
            listener.@de.SimonIT.gdxAppWarp.listener.LobbyRequestListener::onUnSubscribeLobbyDone(Lde/SimonIT/gdxAppWarp/events/LobbyEvent;)(@de.SimonIT.gdxAppWarp.events.LobbyEvent::new(Lde/SimonIT/gdxAppWarp/events/LobbyData;B)(@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getLobbyId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary()), lobby.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetLiveLobbyInfoDone, function (liveRoom) {
            var room = liveRoom.getRoom();
            listener.@de.SimonIT.gdxAppWarp.listener.LobbyRequestListener::onGetLiveLobbyInfoDone(Lde/SimonIT/gdxAppWarp/events/LiveRoomInfoEvent;)(@de.SimonIT.gdxAppWarp.events.LiveRoomInfoEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B[Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), liveRoom.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaStringArray(*)(liveRoom.getUsers()), liveRoom.getCustomData(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaMap(*)(JSON.parse(liveRoom.getProperties())), null));
        });
    }-*/;
	...
	public final native void addRoomRequestListener(RoomRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onSubscribeRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onSubscribeRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onUnsubscribeRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onUnSubscribeRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onJoinRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onJoinRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onLeaveRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onLeaveRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetLiveRoomInfoDone, function (liveRoom) {
            var room = liveRoom.getRoom();
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onGetLiveRoomInfoDone(Lde/SimonIT/gdxAppWarp/events/LiveRoomInfoEvent;)(@de.SimonIT.gdxAppWarp.events.LiveRoomInfoEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B[Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), liveRoom.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaStringArray(*)(liveRoom.getUsers()), liveRoom.getCustomData(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaMap(*)(JSON.parse(liveRoom.getProperties())), null));
        });
        ...
        this.setResponseListener($wnd.AppWarp.Events.onUpdatePropertyDone, function (liveRoom) {
            var room = liveRoom.getRoom();
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onUpdatePropertyDone(Lde/SimonIT/gdxAppWarp/events/LiveRoomInfoEvent;)(@de.SimonIT.gdxAppWarp.events.LiveRoomInfoEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B[Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), liveRoom.getResult(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaStringArray(*)(liveRoom.getUsers()), liveRoom.getCustomData(), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaMap(*)(JSON.parse(liveRoom.getProperties())), null));
        });
        this.setResponseListener($wnd.AppWarp.Events.onLockPropertiesDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onLockPropertiesDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onUnlockPropertiesDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onUnlockPropertiesDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onJoinAndSubscribeRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onJoinAndSubscribeRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
        this.setResponseListener($wnd.AppWarp.Events.onLeaveAndUnsubscribeRoomDone, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.RoomRequestListener::onLeaveAndUnsubscribeRoomDone(Lde/SimonIT/gdxAppWarp/events/RoomEvent;)(@de.SimonIT.gdxAppWarp.events.RoomEvent::new(Lde/SimonIT/gdxAppWarp/events/RoomData;B)(@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers()), room.getResult()));
        });
    }-*/;
	...
	public final native void addTurnBasedRoomListener(TurnBasedRoomListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onSendMoveDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.TurnBasedRoomListener::onSendMoveDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onStartGameDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.TurnBasedRoomListener::onStartGameDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onStopGameDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.TurnBasedRoomListener::onStopGameDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onStopGameDone, function (res, moves) {
            var jmoves = [];
            for (var i = 0; i < moves.length; i++) {
                jmoves[i] = @de.SimonIT.gdxAppWarp.events.MoveEvent::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(moves[i].getSender(), moves[i].getMoveData(), moves[i].getNextTurn(), moves[i].getRoomId());
            }
            listener.@de.SimonIT.gdxAppWarp.listener.TurnBasedRoomListener::onGetMoveHistoryDone(B[Lde/SimonIT/gdxAppWarp/events/MoveEvent;)(res, @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaArray(*)(jmoves));
        });
        this.setResponseListener($wnd.AppWarp.Events.onSetNextTurnDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.TurnBasedRoomListener::onSetNextTurnDone(B)(res);
        });
    }-*/;
	...
	public final native void addChatRequestListener(ChatRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onSendChatDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.ChatRequestListener::onSendChatDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onSendPrivateChatDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.ChatRequestListener::onSendPrivateChatDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onGetChatHistoryDone, function (res, chat) {
            var jchat = [];
            for (var i = 0; i < chat.length; i++) {
                jchat[i] = @de.SimonIT.gdxAppWarp.events.ChatEvent::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)(chat[i].getChat(), chat[i].getSender(), chat[i].getLocId(), chat[i].getIsLocationLobby());
            }
            listener.@de.SimonIT.gdxAppWarp.listener.ChatRequestListener::onGetChatHistoryDone(BLjava/util/List;)(res, @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaList(*)(jchat));
        });
    }-*/;
	...
	public final native void addUpdateRequestListener(UpdateRequestListener listener) /*-{
        this.setResponseListener($wnd.AppWarp.Events.onSendUpdateDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.UpdateRequestListener::onSendUpdateDone(B)(res);
        });
        this.setResponseListener($wnd.AppWarp.Events.onSendPrivateUpdateDone, function (res) {
            listener.@de.SimonIT.gdxAppWarp.listener.UpdateRequestListener::onSendPrivateUpdateDone(B)(res);
        });
    }-*/;
	...
	public final native void addNotificationListener(NotifyListener listener) /*-{
        this.setNotifyListener($wnd.AppWarp.Events.onRoomCreated, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onRoomCreated(Lde/SimonIT/gdxAppWarp/events/RoomData;)((@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers())));
        });
        this.setNotifyListener($wnd.AppWarp.Events.onRoomDestroyed, function (room) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onRoomDestroyed(Lde/SimonIT/gdxAppWarp/events/RoomData;)((@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers())));
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserLeftRoom, function (room, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserLeftRoom(Lde/SimonIT/gdxAppWarp/events/RoomData;Ljava/lang/String;)((@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers())), user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserJoinedRoom, function (room, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserJoinedRoom(Lde/SimonIT/gdxAppWarp/events/RoomData;Ljava/lang/String;)((@de.SimonIT.gdxAppWarp.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(room.getRoomId(), room.getOwner(), room.getName(), room.getMaxUsers())), user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserLeftLobby, function (lobby, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserLeftLobby(Lde/SimonIT/gdxAppWarp/events/LobbyData;Ljava/lang/String;)((@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getRoomId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary())), user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserJoinedLobby, function (lobby, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserJoinedLobby(Lde/SimonIT/gdxAppWarp/events/LobbyData;Ljava/lang/String;)((@de.SimonIT.gdxAppWarp.events.LobbyData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)(lobby.getRoomId(), lobby.getOwner(), lobby.getName(), lobby.getMaxUsers(), lobby.getIsPrimary())), user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onChatReceived, function (chat) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onChatReceived(Lde/SimonIT/gdxAppWarp/events/ChatEvent;)(@de.SimonIT.gdxAppWarp.events.ChatEvent::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)(chat.getChat(), chat.getSender(), chat.getLocId(), chat.getIsLocationLobby()));
        });
        this.setNotifyListener($wnd.AppWarp.Events.onPrivateChatReceived, function (sender, chat) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onPrivateChatReceived(Ljava/lang/String;Ljava/lang/String;)(sender, chat);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onPrivateUpdateReceived, function (userName, msg) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onPrivateUpdateReceived(Ljava/lang/String;[BZ)(userName, msg, true); // I don't know whether true is a good idea
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUpdatePeersReceived, function (payload) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUpdatePeersReceived(Lde/SimonIT/gdxAppWarp/events/UpdateEvent;)(@de.SimonIT.gdxAppWarp.events.UpdateEvent::new([BZ)(@de.SimonIT.gdxAppWarp.util.JsUtil::toJavaByteArray(Lcom/google/gwt/typedarrays/client/Uint8ArrayNative;)(payload), true)); // I don't know whether true is a good idea
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserChangeRoomProperty, function (sender, properties, lockProperties) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserChangeRoomProperty(Lde/SimonIT/gdxAppWarp/events/RoomData;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)(null, sender, @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaMap(*)(properties), @de.SimonIT.gdxAppWarp.util.JsUtil::toJavaMap(*)(lockProperties));  // It seems that no room data is provided
        });
        this.setNotifyListener($wnd.AppWarp.Events.onMoveCompleted, function (move) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onMoveCompleted(Lde/SimonIT/gdxAppWarp/events/MoveEvent;)(@de.SimonIT.gdxAppWarp.events.MoveEvent::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(move.getSender(), move.getMoveData(), move.getNextTurn(), move.getRoomId()));
        });
        this.setNotifyListener($wnd.AppWarp.Events.onGameStarted, function (sender, id, nextTurn) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onGameStarted(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(sender, id, nextTurn);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onGameStopped, function (sender, id) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onGameStopped(Ljava/lang/String;Ljava/lang/String;)(sender, id);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserPaused, function (id, isLobby, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserPaused(Ljava/lang/String;ZLjava/lang/String;)(id, isLobby, user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onUserResumed, function (id, isLobby, user) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onUserResumed(Ljava/lang/String;ZLjava/lang/String;)(id, isLobby, user);
        });
        this.setNotifyListener($wnd.AppWarp.Events.onNextTurnRequested, function (lastTurn) {
            listener.@de.SimonIT.gdxAppWarp.listener.NotifyListener::onNextTurnRequest(Ljava/lang/String;)(lastTurn);
        });
    }-*/;
	...
	public final native void createRoom(String name, String owner, int maxUsers, HashMap<String, Object> tableProperties) /*-{
        this.createRoom(name, owner, maxUsers, @de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(tableProperties));
    }-*/;
	...
	public final native void createTurnRoom(String name, String owner, int maxUsers, HashMap<String, Object> tableProperties, int time) /*-{
        this.createTurnRoom(name, owner, maxUsers, @de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(tableProperties), time);
    }-*/;
	...
	public final native void updateRoomProperties(String roomID, HashMap<String, Object> tableProperties, String[] removeArray) /*-{
        this.updateRoomProperties(roomID, @de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(tableProperties), @com.google.gwt.core.client.JsArrayUtils::readOnlyJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(removeArray));
    }-*/;
	...
	public final native void lockProperties(HashMap<String, Object> tableProperties) /*-{
        this.lockProperties(@de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(tableProperties));
    }-*/;
	...
	public final native void joinRoomWithProperties(HashMap<String, Object> tableProperties) /*-{
        this.joinRoomWithProperties(@de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(tableProperties));
    }-*/;
	...
	public final native void getRoomsWithProperties(HashMap<String, Object> properties) /*-{
        this.getRoomsWithProperties(@de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(properties));
    }-*/;
	...
	public final native void getRoomInRangeWithProperties(int minUser, int maxUsers, HashMap<String, Object> properties) /*-{
        this.getRoomInRangeWithProp(minUser, maxUsers, @de.SimonIT.gdxAppWarp.util.JsUtil::toJsMap(*)(properties));
    }-*/;
