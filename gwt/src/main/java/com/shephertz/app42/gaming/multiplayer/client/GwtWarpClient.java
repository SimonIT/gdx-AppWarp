...
public class GwtWarpClient extends JavaScriptObject implements WarpClient {
	...
	public final native void addZoneRequestListener(ZoneRequestListener listener) /*-{
        ...
        this.setResponseListener(AppWarp.Events.onGetMatchedRoomsDone, function (event) {
            ...
            for (var i = 0; i < rooms.length; i++) {
                roomDatas[i] = @com.shephertz.app42.gaming.multiplayer.client.events.RoomData::new(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)(rooms[i].getRoomId(), rooms[i].getOwner(), rooms[i].getName(), rooms[i].getMaxUsers());
            }
	...
	public final native void addChatRequestListener(ChatRequestListener listener) /*-{
        ...
        this.setResponseListener(AppWarp.Events.onGetChatHistoryDone, function (res, chat) {
            ...
            listener.@com.shephertz.app42.gaming.multiplayer.client.listener.ChatRequestListener::onGetChatHistoryDone(BLjava/util/List;)(res, @com.shephertz.app42.gaming.multiplayer.client.util.JsUtil::toJavaList(*)(jchat));
        });
    }-*/;
